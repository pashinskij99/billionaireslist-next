...
const Cta = () => {
  return (
    <div>
      {/* <!-- CTA --> */}
      <div className='relative mt-12 z-10 dark:bg-jacarta-900'>
        <div className='container'>
          <div className='relative overflow-hidden rounded-2.5xl px-8 md:px-16 pt-8 md:pt-16 pb-8 shadow-md lg:px-24'>
            ...
            <div className='items-center justify-between md:flex'>
              <div className='mb-6 md:w-1/2'>
                <h2 className='mb-4 font-display text-2xl text-center text-jacarta-700 dark:text-white sm:text-3xl'>
                  Having Any Doubts Or Questions?
                </h2>
